			...
			<div className="relative">
				...
				<div className="z-50 min-w-[180px] overflow-hidden border border-border bg-background p-1 text-popover-foreground shadow-md">
					{items.map((item, index) => (
						<button
							className={cn(
								"flex w-full cursor-pointer items-center justify-between px-2 py-1.5 text-[11px] outline-none",
								index === selectedIndex
				...
				{activeSubmenu &&
					...
					currentItem.submenuItems.length > 0 && (
						<div className="absolute top-0 left-full z-50 ml-1 max-h-[300px] min-w-[200px] overflow-hidden overflow-y-auto border border-border bg-background p-1 text-popover-foreground shadow-md">
							{currentItem.submenuItems.map((subItem, index) => (
								<button
									className={cn(
										"flex w-full cursor-pointer flex-col items-start px-2 py-1.5 text-[11px] outline-none",
