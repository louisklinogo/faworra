  ...
  public: {
    Tables: {
      ...
      assignment_policies: {
        ...
        Relationships: [
          {
            foreignKeyName: "assignment_policies_team_id_fkey"
            columns: ["team_id"]
            isOneToOne: false
            referencedRelation: "teams"
            referencedColumns: ["id"]
      ...
      communication_thread_tags: {
        ...
        Relationships: [
          {
            foreignKeyName: "communication_thread_tags_tag_id_fkey"
            columns: ["tag_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "communication_thread_tags_team_id_fkey"
            columns: ["team_id"]
            isOneToOne: false
            referencedRelation: "teams"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "communication_thread_tags_thread_id_fkey"
            columns: ["thread_id"]
            isOneToOne: false
            referencedRelation: "communication_threads"
            referencedColumns: ["id"]
      ...
      event_outbox: {
        ...
        Relationships: [
          {
            foreignKeyName: "event_outbox_team_id_fkey"
            columns: ["team_id"]
            isOneToOne: false
            referencedRelation: "teams"
            referencedColumns: ["id"]
      ...
      macros: {
        ...
        Relationships: [
          {
            foreignKeyName: "macros_team_id_fkey"
            columns: ["team_id"]
            isOneToOne: false
            referencedRelation: "teams"
            referencedColumns: ["id"]
      ...
      saved_inbox_views: {
        ...
        Relationships: [
          {
            foreignKeyName: "saved_inbox_views_owner_user_id_fkey"
            columns: ["owner_user_id"]
            isOneToOne: false
            referencedRelation: "users"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "saved_inbox_views_team_id_fkey"
            columns: ["team_id"]
            isOneToOne: false
            referencedRelation: "teams"
            referencedColumns: ["id"]
