...
export default function LandingPage() {
  ...
  const getDashboardContent = () => {
    switch (activeCard) {
      case 0:
        return (
          <div className="text-[#828387] text-sm">Customer Subscription Status and Details</div>
        );
      case 1:
        return (
          <div className="text-[#828387] text-sm">Analytics Dashboard - Real-time Insights</div>
        );
      case 2:
        return (
          <div className="text-[#828387] text-sm">Data Visualization - Charts and Metrics</div>
        );
      default:
        return (
          <div className="text-[#828387] text-sm">Customer Subscription Status and Details</div>
                      ...
                      <div className="relative h-full w-full overflow-hidden">
                        ...
                        >
                          <img
                            ...
                            src="/data-visualization-dashboard-with-interactive-char.jpg" // Changed from object-cover to object-contain to preserve landscape aspect ratio
                          />
                        </div>
                      </div>
                    </div>
