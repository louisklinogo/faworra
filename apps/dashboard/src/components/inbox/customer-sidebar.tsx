...
import { ChevronRight, MessageSquare, Phone, ShoppingBag, User, X } from "lucide-react";
...
export function CustomerSidebar({ message, isOpen, onClose }: CustomerSidebarProps) {
  ...
  return (
    <div
      className={cn(
        "flex w-[320px] min-h-0 flex-col overflow-hidden border-l bg-background transition-all duration-200",
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-1 text-muted-foreground text-xs">
              <div className="flex justify-between">
                <span>Status:</span>
                <span className="capitalize">{message.threadStatus || message.status}</span>
              </div>
            </div>
            ...
            <div className="space-y-1 text-muted-foreground text-xs">
              <div className="flex justify-between">
                ...
                <span>{message.assigneeId ? "Member" : "Unassigned"}</span>
              </div>
            </div>
          ...
          <div className="space-y-3">
            ...
            {message.leadId ? (
              <div className="flex items-center gap-2 text-xs">
                <Badge className="gap-1 rounded-full px-3 py-0.5" variant="outline">
