...
export const Icons = {
  ...
  FaworraBlack: (props: any) => (
    <Image
      alt="Faworra"
      className={props.className}
      height={props.height || 24}
      src="/Faworra-black.svg"
  ...
  Check: (props?: SVGIconProps) => (
    <SVGIcon {...props}>
      <path d="m14 5.167-8 8L2.333 9.5l.94-.94L6 11.28l7.06-7.053.94.94Z" fill="currentColor" />
    </SVGIcon>
  ),
  ...
  // New icons from Midday
  Bolt: MdBolt,
  DashboardCustomize: MdOutlineDashboardCustomize,
  GraphicEq: MdOutlineGraphicEq,
  ...
  StackedBarChart: MdOutlineStackedBarChart,
  Star: MdOutlineStar,
