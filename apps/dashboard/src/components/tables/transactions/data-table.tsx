...
const NON_CLICKABLE_COLUMNS = new Set(["select", "actions", "category"]);
...
export function DataTable({ initialSettings, initialTab }: DataTableProps) {
				...
				<div className="absolute inset-0 flex items-center justify-center">
					<div className="mx-auto max-w-sm text-center">
						...
						<p className="text-muted-foreground text-sm">
							Everything is exported. New transactions will appear here when
							they are ready to export.
						</p>
					</div>
				</div>
			</div>
				...
				<TooltipProvider delayDuration={20}>
					<Tooltip>
						<div className="w-full">
							<div
								className="scrollbar-hide overflow-auto overscroll-none border-border border-r border-b border-l"
							...
							>
								...
								>
									<Table className="w-full min-w-full">
										...
										<TableBody
											className="block border-r-0 border-l-0"
											style={{
