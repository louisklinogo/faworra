...
import { TableHead, TableHeader, TableRow } from "@faworra-new/ui/components/table";
...
import { NON_REORDERABLE_COLUMNS, STICKY_COLUMNS, SORT_FIELD_MAPS } from "@/utils/table-configs";
