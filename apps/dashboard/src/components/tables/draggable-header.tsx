...
import { TableHead } from "@faworra-new/ui/components/table";
...
export function DraggableHeader({
	...
	return (
		...
		>
			...
			{!disabled && (
				<GripVertical
					className="ml-1 flex-shrink-0 cursor-grab text-muted-foreground opacity-0 active:cursor-grabbing group-hover/header:opacity-100"
					size={14}
					{...attributes}
					{...listeners}
				/>
