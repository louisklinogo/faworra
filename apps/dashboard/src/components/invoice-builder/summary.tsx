    ...
    <div className="w-[320px] flex flex-col">
      <div className="flex justify-between items-center py-1">
        <LabelInput
          ...
          onSave={(value) => {
            persistTemplate({ subtotalLabel: value });
          }}
        />
      ...
      {includeDiscount && (
        <div className="flex justify-between items-center py-1">
          <LabelInput
            ...
            onSave={(value) => {
              persistTemplate({ discountLabel: value });
            }}
          />
        ...
        <div className="flex justify-between items-center py-1">
          <div className="flex items-center gap-1">
            <LabelInput
              ...
              onSave={(value) => {
                persistTemplate({ vatLabel: value });
              }}
            />
        ...
        <div className="flex justify-between items-center py-1">
          <div className="flex items-center gap-1">
            <LabelInput
              ...
              onSave={(value) => {
                persistTemplate({ taxLabel: value });
              }}
            />
      ...
      <div className="flex justify-between items-center py-4 mt-2 border-t border-border">
        <LabelInput
          ...
          onSave={(value) => {
            persistTemplate({ totalSummaryLabel: value });
          }}
        />
