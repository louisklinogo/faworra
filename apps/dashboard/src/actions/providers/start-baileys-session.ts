...
export async function startBaileysSessionAction(params: { externalId: string; displayName: string }) {
  ...
  const res = await fetch(`${base}/providers/whatsapp/baileys/session/start`, {
    ...
    body: JSON.stringify({ externalId: params.externalId, displayName: params.displayName }),
