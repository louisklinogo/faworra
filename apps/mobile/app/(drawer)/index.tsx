...
export default function Home() {
	...
	let connectionStatusLabel = "API Disconnected";
	if (isLoading) {
		connectionStatusLabel = "Checking connection...";
	} else if (isConnected) {
		connectionStatusLabel = "Connected to API";
	}

	return (
		<Container className="p-6">
			<View className="mb-6 py-4">
				<Text className="mb-2 font-bold text-4xl text-foreground">FAWORRA</Text>
			</View>
				...
				<Card className="p-4">
					<View className="flex-row items-center">
						...
						<View className="flex-1">
							...
							<Card.Description>{connectionStatusLabel}</Card.Description>
						</View>
						{isLoading && (
