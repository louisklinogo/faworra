...
export const measurementsRouter = createTRPCRouter({
  list: teamProcedure
    .input(
      z
        .object({
          ...
          offset: z.number().min(OFFSET_MIN).default(OFFSET_DEFAULT),
    ...
    .query(
      async ({ ctx, input }) =>
        await getMeasurementsWithClient(ctx.db, {
          teamId: ctx.teamId,
          limit: input?.limit,
          offset: input?.offset,
  ...
  byId: teamProcedure
    ...
    .query(async ({ ctx, input }) => await getMeasurementById(ctx.db, input.id, ctx.teamId)),
  ...
  getVersions: teamProcedure
    ...
    .query(
      async ({ ctx, input }) =>
        await getMeasurementVersions(ctx.db, {
          teamId: ctx.teamId,
  ...
  getActive: teamProcedure
    ...
    .query(
      async ({ ctx, input }) =>
        await getActiveMeasurement(ctx.db, {
          teamId: ctx.teamId,
  ...
  getHistory: teamProcedure
    ...
    .query(
      async ({ ctx, input }) =>
        await getMeasurementHistory(ctx.db, {
          teamId: ctx.teamId,
          clientId: input.clientId,
        }),
    ),
  ...
  compareVersions: teamProcedure
    ...
    .query(
      async ({ ctx, input }) =>
        await compareMeasurementVersions(ctx.db, {
